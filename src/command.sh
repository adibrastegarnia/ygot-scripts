...
go run github.com/openconfig/ygot/generator/generator.go -path=yang -output_file=pkg/topo/topo.go -package_name=topo -generate_fakeroot -fakeroot_name=topology yang/ietf-network.yang yang/ietf-network-topology.yang
